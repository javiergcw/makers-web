...
const PowerForecastingSection: React.FC = () => {
  return (
    <Box
      sx={{
        width: '100%',
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Our AI-powered forecasting models leverage SCADA data and numerical weather predictions 
            to deliver highly accurate power forecasts for your wind and solar farms, optimizing profitability.
          </Typography>
          ...
          >
            ...
            >
              <iframe
                ...
                title="Jungle AI Power Forecasting Solutions"
                style={{
                  width: '100%',
                  height: '100%',
                  border: 'none',
...
export default PowerForecastingSection; 